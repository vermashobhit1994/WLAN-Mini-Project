""" ################################## MODULE DESCRIPTION #########################
#Module Description : Provides the functionality to display the ssid name of each accesspoint detected for particular channel no and frequency.
...
import convert_list_of_tuples,check_connection_state,Get_WiFi_Interface_Name
...
def extract_all_data():
    ...
    WIFI_INTERFACE_NAME = Get_WiFi_Interface_Name.Get_WiFi_Interface_Name()
    
    if WIFI_INTERFACE_NAME != None and WIFI_INTERFACE_NAME != -1: 
